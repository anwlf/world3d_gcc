...
class vector {
    ...
    friend vector operator -(vector v1,vector v2);
    friend vector operator %(vector v1,vector v2);
    friend vector operator *(vector v,REAL_TYPE r);
    friend vector operator *(REAL_TYPE r,vector v);
    friend vector operator /(vector v,REAL_TYPE r);
    friend REAL_TYPE operator *(vector v1,vector v2);
    friend vector operator *(matrix m,vector v);
    friend REAL_TYPE abs(vector v);
    friend vector ort(vector v);
...
class location :public vector {
	...
	location(REAL_TYPE e0,REAL_TYPE e1=0,REAL_TYPE e2=0) : vector(e0,e1,e2) {}
